...
public class AnimalRep implements IRep<Animal> {
        ...
        try {
            ...
            try (Connection dbConnection = getConnection()) {
                ...
                while (resultSet.next()) {
                    ...
                    pet = AnimalCreator.createPet(type, name, birthday);
                    pet.setPetId(id);
                    farm.add(pet);
                }
                return farm;
            ...
            Logger.getLogger(AnimalRep.class.getName()).log(Level.SEVERE, null, ex);
